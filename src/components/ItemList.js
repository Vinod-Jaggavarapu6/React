      ...
      {items?.map((item) => (
        ...
        >
          ...
          <div className="relative w-3/12">
            ...
            />
            <button className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 p-2 bg-white text-green-500 font-bold text-sm shadow-lg rounded-md">
              Add +
            </button>
          </div>
        </div>
